...
PDF_IDESArray = zeros(Numb_PDF_Iterations,1);
PDF_RPRAArray = zeros(Numb_PDF_Iterations,1);
PDF_RPRAArray2 = zeros(Numb_PDF_Iterations,1);
...
PDF_IDESArray(index_PDF) = mean(AverageReputAllIDES,'all');
PDF_RPRAArray(index_PDF) = mean(yLoggedAvergReputAll,'all');
PDF_RPRAArray2(index_PDF) = mean(AverageReputAll,'all');
% RPRA_Vs_IDES18June2023.mat is the mnatlab data file ....updated 25 October 2023
end
% "yLoggedAvergReputAll" is the variable saving the values of RPRA...updated % 25 October 2023
% Another full version workspace saving we are using is "RPRA_AllMethods25Oct2023_PDF_generationWorkspaceV1.mat"
